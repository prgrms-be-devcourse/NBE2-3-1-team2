...
const customer = document.getElementById('total-customer');
const purchase = document.getElementById('daily-purchase');
const product = document.getElementById('pending-product');
